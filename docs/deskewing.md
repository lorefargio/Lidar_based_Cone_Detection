...
$$\mathbf{T}_{\text{imu}\to\text{lidar}} = \begin{bmatrix} \mathbf{R}_{\text{im}\_l} & \mathbf{t}_{\text{im}\_l} \\ 0 & 1 \end{bmatrix}$$

1.  **Transform to Center of Rotation (IMU frame)**:
    $$p_{\text{imu}} = \mathbf{R}_{\text{im}\_l} \cdot p_l + \mathbf{t}_{\text{im}\_l}$$
...
3.  **Transform Back to LiDAR frame**:
    $$p'_{\text{rotated}} = \mathbf{R}_{\text{im}\_l}^T \cdot (p'_{\text{imu}} - \mathbf{t}_{\text{im}\_l})$$
...
$$\mathbf{a}_l = \mathbf{R}_{\text{im}\_l}^T \cdot (\mathbf{a}_{\text{imu\_accel}} + \mathbf{\omega} \times (\mathbf{\omega} \times \mathbf{t}_{\text{im}\_l})) - \mathbf{g}_l$$
